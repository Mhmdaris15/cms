                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            <img className="w-8 ml-[5px] flex-none" src="/assets/images/LogoAngkie.svg" alt="logo" />
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">{t('AngkieYudistira')}</span>
                        </NavLink>
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Content')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                </ul>
                        ...
                        <div
                            ...
                            className="text-black text-lg flex text-center justify-start gap-2 items-center fixed bottom-4 left-4 border-t-[1px] border-black/40 w-[230px] h-[40px] "
                        >
                            <MdOutlineLogout />
